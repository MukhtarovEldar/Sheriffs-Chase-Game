...
def draw_text_with_outline(surface, text, font, x, y, text_color,
                           outline_color=-1, outline_size=2):
    """
        ...
        for dx, dy in ((-1, -1), (-1, 1), (1, -1), (1, 1)):
            for i in range(outline_size):
                surface.blit(font.render(
                    text, True, outline_color), (x + dx*i, y + dy*i))
...
def start_screen_loop(screen, WINDOW_WIDTH=1440, WINDOW_HEIGHT=512):
    ...
    intro_image = pygame.transform.scale(
        intro_image, (WINDOW_WIDTH, WINDOW_HEIGHT))

    intro_sound = pygame.mixer.Sound(
        "./Game_Files/sound/581415__peanut_shaman__western-bass.wav")
    ...
    while start_screen:
        ...
        start_button_rect = pygame.draw.rect(
            screen, (65, 31, 41, 0), (WINDOW_WIDTH // 2 - 107, 178, 199, 63), 1)
        quit_button_rect = pygame.draw.rect(
            screen, (0, 0, 0, 0), (WINDOW_WIDTH // 2 - 107, 268, 199, 63), 1)
        contribute_button_rect = pygame.draw.rect(
            screen, (180, 84, 60, 0), (
                WINDOW_WIDTH // 2 - 130, 385, 249, 45), 1)
        if start_button_rect.collidepoint(pygame.mouse.get_pos()):
            draw_text_with_outline(
                screen, "Start", font, WINDOW_WIDTH // 2 - 60,
                188, (253, 236, 193), (0, 24, 29))
        else:
            draw_text_with_outline(
                screen, "Start", font, WINDOW_WIDTH // 2 - 60,
                188, (40, 20, 22))
        ...
        if quit_button_rect.collidepoint(pygame.mouse.get_pos()):
            draw_text_with_outline(
                screen, "Quit", font, WINDOW_WIDTH // 2 - 46,
                278, (253, 236, 193), (0, 24, 29))
        else:
            draw_text_with_outline(
                screen, "Quit", font, WINDOW_WIDTH // 2 - 46,
                278, (40, 20, 22))
        ...
        if contribute_button_rect.collidepoint(pygame.mouse.get_pos()):
            draw_text_with_outline(
                screen, "Contribute", font, WINDOW_WIDTH // 2 - 107,
                387, (253, 236, 193), (0, 24, 29))
        else:
            draw_text_with_outline(
                screen, "Contribute", font, WINDOW_WIDTH // 2 - 107,
                387, (40, 20, 22))
        ...
        draw_text_with_outline(
            screen, "Press space to play", pygame.font.Font(font_name, 15),
            WINDOW_WIDTH // 2 - 97, 445, (255, 255, 255))
...
def pause_screen_loop(screen, WINDOW_WIDTH=1440, WINDOW_HEIGHT=512):
    ...
    pause_image = pygame.image.load(
        "./Game_Files/UI/pause.png").convert_alpha()
    pause_image = pygame.transform.scale(
        pause_image, (WINDOW_WIDTH, WINDOW_HEIGHT))
    ...
    while pause_screen:
        ...
        resume_button_rect = pygame.draw.rect(
            screen, (0, 0, 0, 0), (WINDOW_WIDTH // 2 - 107, 178, 199, 63), 1)
        quit_button_rect = pygame.draw.rect(
            screen, (0, 0, 0, 0), (WINDOW_WIDTH // 2 - 107, 268, 199, 63), 1)
        contribute_button_rect = pygame.draw.rect(
            screen, (180, 84, 60, 0),
        ...
        if resume_button_rect.collidepoint(pygame.mouse.get_pos()):
            draw_text_with_outline(
                screen, "Resume", font, WINDOW_WIDTH // 2 - 70,
                188, (253, 236, 193), (0, 24, 29))
        else:
            draw_text_with_outline(
                screen, "Resume", font, WINDOW_WIDTH // 2 - 70,
...
def story(screen, WINDOW_WIDTH=1440, WINDOW_HEIGHT=512):
    ...
    story_images = []
    for i in range(1, 5):
        story_images.append(pygame.image.load(
            f"./Game_Files/UI/background/scene{i}.png").convert_alpha())
    story_images = [pygame.transform.scale(
        image, (WINDOW_WIDTH, WINDOW_HEIGHT)) for image in story_images]
    ...
    while story_screen:
        ...
        draw_text_with_outline(
            screen, "Press space to skip", pygame.font.Font(font_name, 15),
            WINDOW_WIDTH // 2 - 80, 445, (255, 255, 255))
...
def game_over_screen_loop(
    ...
    game_over_image = pygame.image.load(
        "./Game_Files/UI/game_over.png").convert_alpha()
    game_over_image = pygame.transform.scale(
        game_over_image, (WINDOW_WIDTH, WINDOW_HEIGHT))
    ...
    while True:
        ...
        try_again_button_rect = pygame.draw.rect(
            screen, (65, 31, 41, 0), (WINDOW_WIDTH // 2 - 118, 202, 235, 63), 1)
        quit_button_rect = pygame.draw.rect(
            screen, (0, 0, 0, 0), (WINDOW_WIDTH // 2 - 118, 292, 235, 63), 1)
        contribute_button_rect = pygame.draw.rect(
            screen, (180, 84, 60, 0),
            (WINDOW_WIDTH // 2 - 123, 400, 249, 45), 1)
        if try_again_button_rect.collidepoint(pygame.mouse.get_pos()):
            draw_text_with_outline(
                screen, "Try Again", font, WINDOW_WIDTH // 2 - 90,
                210, (253, 236, 193), (0, 24, 29))
        else:
            draw_text_with_outline(
                screen, "Try Again", font, WINDOW_WIDTH // 2 - 90,
                210, (40, 20, 22))
        ...
        if quit_button_rect.collidepoint(pygame.mouse.get_pos()):
            draw_text_with_outline(
                screen, "Quit", font, WINDOW_WIDTH // 2 - 38,
                302, (253, 236, 193), (0, 24, 29))
        else:
            draw_text_with_outline(
                screen, "Quit", font, WINDOW_WIDTH // 2 - 38,
                302, (40, 20, 22))
        ...
        if contribute_button_rect.collidepoint(pygame.mouse.get_pos()):
            draw_text_with_outline(
                screen, "Contribute", font, WINDOW_WIDTH // 2 - 100,
                401, (253, 236, 193), (0, 24, 29))
        else:
            draw_text_with_outline(
                screen, "Contribute", font, WINDOW_WIDTH // 2 - 100,
                401, (40, 20, 22))
        ...
        draw_text_with_outline(
            screen, "Press space to replay", pygame.font.Font(font_name, 15),
            WINDOW_WIDTH // 2 - 97, 460, (255, 255, 255))

        font_score = pygame.font.Font(
            "./Game_Files/UI/Carnevalee Freakshow.ttf", 35)

        # Write best_score and current_score to the screen
        draw_text_with_outline(
            screen, str(best_score), font_score,
            WINDOW_WIDTH // 2 + 55, 90, (253, 236, 193), (0, 24, 29))
        draw_text_with_outline(
            screen, str(current_score), font_score, WINDOW_WIDTH // 2 + 55,
            125, (253, 236, 193), (0, 24, 29))
